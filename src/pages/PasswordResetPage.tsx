...
type PasswordResetProps = { userId: string };

function PasswordResetPage({ userId }: PasswordResetProps): JSX.Element {
  ...
  async function changePassword(event: SyntheticEvent) {
